...
export default function FinanceSidebar() {
  ...
  return (
    <aside
      ...
      className={`sticky top-0 hidden h-screen shrink-0 border-r border-white/10 bg-slate-950/95 px-3 py-5 shadow-2xl shadow-black/30 transition-all duration-300 lg:block ${isExpanded ? "w-72" : "w-20"
        }`}
    >
