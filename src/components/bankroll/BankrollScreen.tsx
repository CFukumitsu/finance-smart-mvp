...
const gameTypeOptions: Record<BankrollSessionType, string[]> = {
  tournament: [
    "NL Hold'em",
    "PLO4",
    "PLO5",
  ...
  sit_and_go: ["NL Hold'em", "PLO4", "PLO5", "Heads-up"],
  spin: ["Spin & Go", "Spin Gold"],
  other: [
    "NL Hold'em",
    "PLO4",
    "PLO5",
...
const formatOptions: Record<BankrollSessionType, string[]> = {
  tournament: [
    "Freezeout",
    "Reentry",
    "Rebuy",
  ...
  spin: ["3-Max", "Heads-up", "Turbo", "Hyper Turbo", "Outro"],
  other: [
    "Regular",
    "Heads-up",
    "6-Max",
...
function Sessions({
  ...
  const selectedSessionType = form.session_type as BankrollSessionType;

  const availableGameTypes =
    gameTypeOptions[selectedSessionType] ?? gameTypeOptions.other;

  const availableFormats =
    formatOptions[selectedSessionType] ?? formatOptions.other;

  const displayedGameTypes =
    form.game_type && !availableGameTypes.includes(form.game_type)
      ? [form.game_type, ...availableGameTypes]
      : availableGameTypes;

  const displayedFormats =
    form.format && !availableFormats.includes(form.format)
            ...
            <Input label="Tipo">
              <select
                ...
                onChange={(e) => {
                  ...
                  const firstGameType = gameTypeOptions[sessionType]?.[0] ?? "";
