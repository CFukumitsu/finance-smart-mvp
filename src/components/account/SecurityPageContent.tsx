...
export default function SecurityPageContent() {
  ...
  return <AppShell><div className="mx-auto max-w-4xl space-y-6">
    ...
    <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
      <MutationScope busy={mutation.isPending} isLocked={mutation.isLocked}><form onSubmit={submit} className="space-y-5 rounded-3xl border border-white/10 bg-slate-900/50 p-5 sm:p-7">
        ...
        <ProcessingButton busy={mutation.pending === ("submit")} disabled={mutation.isPending || (saving)} className="w-full rounded-xl bg-blue-600 px-5 py-3 font-bold hover:bg-blue-500 disabled:opacity-50">{saving ? "Alterando..." : "Alterar senha"}</ProcessingButton>
      </form></MutationScope>
